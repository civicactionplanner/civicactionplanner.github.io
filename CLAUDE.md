...
- Design tokens live at the top of the template's `<style>`. Light and dark palettes were validated for color-vision separation; if you change category colors, re-check adjacent pairs.
